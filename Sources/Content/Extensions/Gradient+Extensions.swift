...
extension Gradient {
    ...
    static let temperatureGradient = Gradient(stops: [
        ...
        Gradient.Stop(color: .freezing, location: 0.15),      // Light Blue (15%)
        Gradient.Stop(color: .cold, location: 0.30),      // Soft Blue (30%)
        Gradient.Stop(color: .cool, location: 0.50),   // White (50%)
        Gradient.Stop(color: .neutral, location: 0.70),      // Light Orange (70%)
        Gradient.Stop(color: .warm, location: 0.85),       // Deep Orange (85%)
